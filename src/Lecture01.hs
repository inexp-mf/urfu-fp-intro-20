...
howManyDigits n = if n < 0 then howManyDigits (-n) else if n < 10 then "single" else if n < 100 then "two-digit" else "three-digit or more"
...
-}
digitsCount :: Int -> Int
digitsCount n = if n < 0 then digitsCount (-n) 
else if n < 10 then 1 
